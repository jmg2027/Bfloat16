...
#        return self.exponent == 0 and self.mantissa == 0
    ...
    @classmethod
    def from_float(cls: Type[FloatBaseT], fp: float) -> FloatBaseT:
        bf16_bias = cls._bias
    ...
    @classmethod
    def from_hex(cls: Type[FloatBaseT], h: int) -> FloatBaseT:
    ...
    def __add__(self: FloatBaseT, other: FloatBaseT) -> FloatBaseT:
    ...
    def __mul__(self: FloatBaseT, other: FloatBaseT) -> FloatBaseT:
        if not isinstance(other, FloatBase):
            raise FloatTypeError("Both operands should be FloatBase objects.")
        if type(self) is not type(other):
            raise FloatTypeError("Both operands should be of the same type.")
    ...
    @classmethod
    def fma(cls: Type[FloatBaseT], a: FloatBaseT, b: FloatBaseT, c: FloatBaseT) -> FloatBaseT:
    ...
    '''
    @classmethod
    def mru(cls: Type[FloatBaseT], input_vector, weight_vector) -> FloatBaseT:
    ...
    @classmethod
    def inttofp(cls, i: int) -> 'FloatBase':
        # HW component
        # Exists in fpmiscop
