...
# debug: in this case, isn't it not to round up case? It seems tf round this up
        ...
        (0, 0, 4.5),
        (4.5, 2.8, 0),
        #FAILED FMA(-1.452410879826985e+17, -2.6893296075324036e-20, -3.1363800445660672e-15), bf16: Bfloat16(0.001953125, sign = 0, exponent=-9, mantissa=0), tfbf16: 0.00390625
        (-1.452410879826985e+17, -2.6893296075324036e-20, -3.1363800445660672e-15),
]
